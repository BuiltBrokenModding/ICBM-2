 ...
 */
public class TileTurret extends TileTerminal implements IProfileContainer, IRotatable, IGyroMotor, IExternalInventory, IBlockActivate
{
	...
	public void readFromNBT(NBTTagCompound nbt)
	{
		...
		if (nbt.hasKey("sentryTile"))
		{
			...
			saveManagerSentryKey = tag.getString("sentryID");
