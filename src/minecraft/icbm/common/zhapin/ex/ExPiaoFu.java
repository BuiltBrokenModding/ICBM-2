...
public class ExPiaoFu extends ZhaPin
{
	...
	public void init()
	{
		RecipeHelper.addRecipe(new ShapedOreRecipe(this.getItemStack(), new Object[] { "EEE", "ETE", "EEE", 'R', tui.getItemStack(), 'E', Item.eyeOfEnder }), this.getName(), ZhuYao.CONFIGURATION, true);
	}
