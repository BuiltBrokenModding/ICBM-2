...
public class AntimatterFX extends EntityFX
{
	float antimatterParticleScale;

	public AntimatterFX(World par1World, Vector3 position, double par8, double par10, double par12, double distance)
	{
		this(par1World, position, par8, par10, par12, 1.0F, distance);
	}

	public AntimatterFX(World par1World, Vector3 position, double par8, double par10, double par12, float par14, double distance)
	{
	...
	public void renderParticle(Tessellator tessellator, float par2, float par3, float par4, float par5, float par6, float par7)
	{
		...
		ForgeHooksClient.bindTexture(ZhuYao.TEXTURE_FILE_PATH + "antimatter.png", 0);
		...
		GL11.glPopMatrix();
		GL11.glBindTexture(3553, FMLClientHandler.instance().getClient().renderEngine.getTexture(ZhuYao.TEXTURE_FILE_PATH + "antimatter.png"));
