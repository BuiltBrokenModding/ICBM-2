				...
				for (Object obj : source.dataList)
				{
					...
					if (chance > distanceFromCenter * 0.55)
					{
						...
						if ((blockID == 0 || blockID == Block.snow.blockID) && worldObj.getBlockMaterial((int) targetPosition.x, (int) targetPosition.y - 1, (int) targetPosition.z).isSolid())
						{
							...
							{
								worldObj.setBlock((int) targetPosition.x, (int) targetPosition.y, (int) targetPosition.z, Block.lavaMoving.blockID, 0, 2);
							}
							else
							{
								...
								{
									worldObj.setBlock((int) targetPosition.x, (int) targetPosition.y - 1, (int) targetPosition.z, Block.netherrack.blockID, 0, 2);
								}
							}
						}
