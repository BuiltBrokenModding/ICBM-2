...
public class GuiRadarStation extends ICBMGui
{
	...
	protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
    {
    	...
    	{
	    	for(EntityMissile missile : this.tileEntity.detectedMissiles)
	        {
        ...
        for(TileEntityRadarStation radarStation : this.tileEntity.detectedRadarStations)
        {
