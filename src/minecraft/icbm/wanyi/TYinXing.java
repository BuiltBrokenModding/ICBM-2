...
public class TYinXing extends TileEntity implements IPacketReceiver
{
	...
	{
		return PacketManager.getPacket(ZhuYaoZhaPin.CHANNEL, this, this.jiaHaoMa, this.jiaMetadata, this.qingBian[0], this.qingBian[1], this.qingBian[2], this.qingBian[3], this.qingBian[4], this.qingBian[5], this.isYing);
	}
