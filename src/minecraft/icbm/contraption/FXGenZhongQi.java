...
public class FXGenZhongQi extends FMLTextureFX
{
	...
	public FXGenZhongQi(Minecraft par1Minecraft)
	{
		super(ZhuYaoContraption.itGenZongQi.getIconFromDamage(0));
	...
	public void onTick()
	{
		...
		if (this.mc.theWorld != null && this.mc.thePlayer != null)
		{
			...
			{
				if (this.mc.thePlayer.getCurrentEquippedItem().itemID == ZhuYaoContraption.itGenZongQi.itemID)
				{
