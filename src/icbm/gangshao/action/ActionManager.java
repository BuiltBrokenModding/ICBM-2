...
public class ActionManager
{
	...
	public Action getNewCommand(TPaoDaiBase tileEntity, Class<? extends Action> commandClass, String[] parameters)
	{
		try
		{
	 ...
	 */
	public void addCommand(TPaoDaiBase tileEntity, Class<? extends Action> commandClass, String[] parameters)
	{
	...
	public void addCommand(TPaoDaiBase tileEntity, Class<? extends Action> task)
	{
