...
public class ActionRotateTo extends Action
{
	...
	public void onTaskStart()
	{
		...
		while (this.targetRotationPitch < TPaoDaiBase.MIN_PITCH)
		{
			this.targetRotationPitch += TPaoDaiBase.MIN_PITCH;
		}
		while (this.targetRotationPitch > TPaoDaiBase.MAX_PITCH)
		{
			this.targetRotationPitch -= TPaoDaiBase.MAX_PITCH;
		}
	}
