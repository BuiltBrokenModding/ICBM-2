...
public class FXLaser extends EntityFX
{
	...
	public FXLaser(World par1World, Vector3 position, Vector3 target, float red, float green, float blue, int age)
	{
	...
	public void renderParticle(Tessellator tessellator, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		Minecraft.getMinecraft().renderEngine.bindTexture(ZhuYao.TEXTURE_PATH + "noise.png");
