...
public abstract class GuiPlatformBase extends GuiBase
{
	...
	public void initGui()
	{
		...
		PacketDispatcher.sendPacketToServer(PacketManager.getPacket(ZhuYaoGangShao.CHANNEL, this.tileEntity, TerminalPacketType.GUI_EVENT.ordinal(), true));
	}
	...
	{
		super.onGuiClosed();
		PacketDispatcher.sendPacketToServer(PacketManager.getPacket(ZhuYaoGangShao.CHANNEL, this.tileEntity, TerminalPacketType.GUI_EVENT.ordinal(), false));
	}
