...
public class GYinGanQi extends GuiBase
{
	...
	public void initGui()
	{
		...
		PacketDispatcher.sendPacketToServer(PacketManager.getPacket(ZhuYaoWanYi.CHANNEL, this.tileEntity, -1, true));
	...
	{
		super.onGuiClosed();
		PacketDispatcher.sendPacketToServer(PacketManager.getPacket(ZhuYaoWanYi.CHANNEL, this.tileEntity, -1, false));
	...
	protected void actionPerformed(GuiButton par1GuiButton)
	{
		if (par1GuiButton.id == 0)
		{
			...
			PacketDispatcher.sendPacketToServer(PacketManager.getPacket(ZhuYaoWanYi.CHANNEL, this.tileEntity, 2, this.tileEntity.mode));
		}
	}
	...
	public void keyTyped(char par1, int par2)
	{
		...
		try
		{
			...
			PacketDispatcher.sendPacketToServer(PacketManager.getPacket(ZhuYaoWanYi.CHANNEL, this.tileEntity, 4, this.tileEntity.minCoord.intX(), this.tileEntity.minCoord.intY(), this.tileEntity.minCoord.intZ()));
		}
		catch (Exception e)
		{
		}
		...
		try
		{
			...
			PacketDispatcher.sendPacketToServer(PacketManager.getPacket(ZhuYaoWanYi.CHANNEL, this.tileEntity, 5, this.tileEntity.maxCoord.intX(), this.tileEntity.maxCoord.intY(), this.tileEntity.maxCoord.intZ()));
		}
		catch (Exception e)
		{
		...
		try
		{
			...
			PacketDispatcher.sendPacketToServer(PacketManager.getPacket(ZhuYaoWanYi.CHANNEL, this.tileEntity, 3, this.tileEntity.frequency));
		}
		catch (Exception e)
		{
