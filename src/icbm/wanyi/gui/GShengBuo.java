...
public class GShengBuo extends GuiBase {
	...
	public void initGui() {
		...
		this.textFieldFrequency.setText(((IItemFrequency) this.itemStack
				.getItem()).getFrequency(this.itemStack) + "");
	}
	...
	public void keyTyped(char par1, int par2) {
		...
		try {
			short newFrequency = (short) Math.max(0,
					Short.parseShort(this.textFieldFrequency.getText()));
			...
			if (((IItemFrequency) this.itemStack.getItem())
				...
				((IItemFrequency) this.itemStack.getItem()).setFrequency(
						newFrequency, this.itemStack);
				PacketDispatcher.sendPacketToServer(PacketManager
						.getPacketWithID(ZhuYaoWanYi.CHANNEL,
								WanYiPacketType.HUO_LUAN.ordinal(),
								newFrequency));
			}
