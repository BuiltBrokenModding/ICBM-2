...
public class BZha extends BICBM {
	...
	public void registerIcons(IconRegister iconRegister) {
		...
		this.iconPoison = iconRegister.registerIcon(this.getUnlocalizedName()
				.replace("tile.", "") + "Poison");
		this.iconFlammable = iconRegister.registerIcon(this
				.getUnlocalizedName().replace("tile.", "") + "Flammable");
	}
	...
	public boolean canBlockStay(World par1World, int par2, int par3, int par4) {
		return par1World.isBlockSolidOnSide(par2 - 1, par3, par4,
				...
				par1World.getBlockId(par2 - 1, par3, par4) == Block.pistonExtension.blockID
				|| par1World.getBlockId(par2 + 1, par3, par4) == Block.pistonExtension.blockID
				|| par1World.getBlockId(par2, par3, par4 - 1) == Block.pistonExtension.blockID
				|| par1World.getBlockId(par2, par3, par4 + 1) == Block.pistonExtension.blockID
				|| par1World.getBlockId(par2, par3 + 1, par4) == Block.pistonExtension.blockID
				|| par1World.getBlockId(par2, par3 - 1, par4) == Block.pistonExtension.blockID
				||
				...
				par1World.getBlockId(par2 - 1, par3, par4) == Block.pistonStickyBase.blockID
				|| par1World.getBlockId(par2 + 1, par3, par4) == Block.pistonStickyBase.blockID
				|| par1World.getBlockId(par2, par3, par4 - 1) == Block.pistonStickyBase.blockID
				|| par1World.getBlockId(par2, par3, par4 + 1) == Block.pistonStickyBase.blockID
				|| par1World.getBlockId(par2, par3 + 1, par4) == Block.pistonStickyBase.blockID
				|| par1World.getBlockId(par2, par3 - 1, par4) == Block.pistonStickyBase.blockID;
	}
