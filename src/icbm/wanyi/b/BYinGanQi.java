...
public class BYinGanQi extends BICBM {
	...
	public boolean onMachineActivated(World par1World, int x, int y, int z,
			...
			float hitZ) {
		par5EntityPlayer.openGui(ZhuYaoWanYi.instance,
				ZhuYaoICBM.GUI_YIN_GAN_QI, par1World, x, y, z);
		return true;
	}
	...
	/**
	 * Override this if you do not want your machine to be added to the creative
	 * menu or if you have metadata machines and want to add more machines to
	 * the creative menu.
	 */
	@Override
