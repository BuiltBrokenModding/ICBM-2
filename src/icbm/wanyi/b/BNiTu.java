...
public class BNiTu extends BICBM implements IAntiPoisonBlock {
	...
	public void registerIcons(IconRegister iconRegister) {
		...
		this.iconCompact = iconRegister.registerIcon(this.getUnlocalizedName()
				.replace("tile.", "") + "Compact");
		this.iconReinforced = iconRegister.registerIcon(this
				.getUnlocalizedName().replace("tile.", "") + "Reinforced");
