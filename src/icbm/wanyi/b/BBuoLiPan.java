...
public class BBuoLiPan extends BlockPressurePlate {
	public BBuoLiPan(int id) {
		super(id, ZhuYaoICBM.PREFIX + "glassPressurePlate", Material.glass,
				EnumMobType.everything);
		this.setTickRandomly(true);
		this.setResistance(1F);
		this.setHardness(0.3F);
		this.setStepSound(soundGlassFootstep);
		this.setUnlocalizedName(ZhuYaoICBM.PREFIX + "glassPressurePlate");
		this.setCreativeTab(ICBMTab.INSTANCE);
	}

	@Override
	protected void setStateIfMobInteractsWithPlate(World par1World, int par2,
