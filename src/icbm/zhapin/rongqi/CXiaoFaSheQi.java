...
public class CXiaoFaSheQi extends Container {
	...
	public CXiaoFaSheQi(InventoryPlayer par1InventoryPlayer,
			TXiaoFaSheQi tileEntity) {
		this.tileEntity = tileEntity;
		// Missile Slot
		this.addSlotToContainer(new SlotSpecific(tileEntity, 0, 151, 23,
				ItDaoDan.class));
		// Battery Slot
		this.addSlotToContainer(new SlotSpecific(tileEntity, 1, 151, 47,
				IItemElectric.class));
