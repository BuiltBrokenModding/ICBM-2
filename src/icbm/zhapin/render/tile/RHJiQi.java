			...
			if (metadata < JiQi.FaSheDi.ordinal() * 3 + 3) {
				...
				if (tier == 0) {
					FMLClientHandler.instance().getClient().renderEngine
							.func_110577_a(RFaSheDi.TEXTURE_FILE_0);
					RFaSheDi.modelBase0.render(0.0625F);
					RFaSheDi.modelRail0.render(0.0625F);
				} else if (tier == 1) {
					FMLClientHandler.instance().getClient().renderEngine
							.func_110577_a(RFaSheDi.TEXTURE_FILE_1);
					...
					FMLClientHandler.instance().getClient().renderEngine
							.func_110577_a(RFaSheDi.TEXTURE_FILE_2);
				...
				if (tier == 0) {
					FMLClientHandler.instance().getClient().renderEngine
							.func_110577_a(RFaSheShiMuo.TEXTURE_FILE_0);
					RFaSheShiMuo.model0.render(0.0625F);
				} else if (tier == 1) {
					FMLClientHandler.instance().getClient().renderEngine
							.func_110577_a(RFaSheShiMuo.TEXTURE_FILE_1);
					RFaSheShiMuo.model1.render(0.0625F);
				} else if (tier == 2) {
					FMLClientHandler.instance().getClient().renderEngine
							.func_110577_a(RFaSheShiMuo.TEXTURE_FILE_2);
				...
				FMLClientHandler.instance().getClient().renderEngine
						.func_110577_a(RFaSheJia.TEXTURE_FILE);
				...
				FMLClientHandler.instance().getClient().renderEngine
						.func_110577_a(RLeiDaTai.TEXTURE_FILE);
				...
				FMLClientHandler.instance().getClient().renderEngine
						.func_110577_a(RDianCiQi.TEXTURE_FILE);
				...
				FMLClientHandler.instance().getClient().renderEngine
						.func_110577_a(RXiaoFaSheQi.TEXTURE_FILE);
				...
				FMLClientHandler.instance().getClient().renderEngine
						.func_110577_a(RYinDaoQi.TEXTURE_FILE);
