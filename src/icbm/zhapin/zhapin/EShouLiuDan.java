...
public class EShouLiuDan extends Entity implements IExplosiveContainer,
	...
	public EShouLiuDan(World par1World, EntityLivingBase par2EntityLiving,
			int explosiveID, float nengLiang) {
		this(par1World);
	...
	public void onUpdate() {
		if (!this.worldObj.isRemote) {
			if (ZhuYaoZhaPin.shiBaoHu(this.worldObj, new Vector3(this),
					ExplosiveType.ITEM, this.haoMa)) {
				float var6 = 0.7F;
				double var7 = this.worldObj.rand.nextFloat() * var6
						+ (1.0F - var6) * 0.5D;
				double var9 = this.worldObj.rand.nextFloat() * var6
						+ (1.0F - var6) * 0.5D;
				double var11 = this.worldObj.rand.nextFloat() * var6
						+ (1.0F - var6) * 0.5D;
				EntityItem var13 = new EntityItem(this.worldObj, this.posX
						+ var7, this.posY + var9, this.posZ + var11,
						new ItemStack(ZhuYaoZhaPin.itShouLiuDan, this.haoMa, 1));
		...
		for (this.rotationPitch = (float) (Math.atan2(this.motionY, var16) * 180.0D / Math.PI); this.rotationPitch
		...
		if (this.isInWater()) {
			for (int var7 = 0; var7 < 4; ++var7) {
				...
				this.worldObj.spawnParticle("bubble", this.posX - this.motionX
						* var19, this.posY - this.motionY * var19, this.posZ
						- this.motionZ * var19, this.motionX, this.motionY,
						this.motionZ);
			}
		...
		if (this.ticksExisted > Math.max(60,
				((ZhaPin) this.getExplosiveType()).getYinXin())) {
			this.worldObj.spawnParticle("hugeexplosion", this.posX, this.posY,
					this.posZ, 0.0D, 0.0D, 0.0D);
			((ZhaPin) this.getExplosiveType()).createExplosion(this.worldObj,
					this.posX, this.posY, this.posZ, this);
			this.setDead();
			return;
		} else {
			((ZhaPin) this.getExplosiveType()).onYinZha(this.worldObj,
					new Vector3(this.posX, this.posY + 0.5, this.posZ),
					this.ticksExisted);
		}
	}
