...
public class FXZhenBuo extends EntityFX {
	public FXZhenBuo(World par1World, Vector3 position, float par8,
			float par10, float par12, double distance) {
		this(par1World, position, par8, par10, par12, 1.0F, distance);
	}

	public FXZhenBuo(World par1World, Vector3 position, float r, float g,
			float b, float size, double distance) {
	...
	public void renderParticle(Tessellator tessellator, float par2, float par3,
		...
		GL11.glColor4f(this.particleRed / 255, this.particleGreen / 255,
				this.particleBlue / 255, 0.5f);
