...
public class BzYuanZi extends BaoZha
{
	...
	public void doPreExplode()
	{
		...
		this.worldObj.playSoundEffect(this.position.x, this.position.y, this.position.z, "icbm.explosion", 7.0F, (1.0F + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) * 0.2F) * 0.7F);
	}
	...
	public void doPostExplode()
	{
		...
		this.worldObj.playSoundEffect(this.position.x, this.position.y, this.position.z, "icbm.explosion", 10.0F, (1.0F + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) * 0.2F) * 0.7F);
	}
