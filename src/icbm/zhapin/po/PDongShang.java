...
public class PDongShang extends PICBM {
	...
	public void performEffect(EntityLivingBase par1EntityLiving, int amplifier) {
		...
		if (par1EntityLiving.worldObj.getBlockId(
				MathHelper.floor_double(par1EntityLiving.posX),
				MathHelper.floor_double(par1EntityLiving.posY) - 1,
				MathHelper.floor_double(par1EntityLiving.posZ)) == Block.ice.blockID) {
