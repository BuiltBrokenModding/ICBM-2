				...
				else
				{
					...
					if (airStrikeFreq > 0)
					{
						if (this.getElectricityStored(par1ItemStack) > YONG_DIAN_LIANG)
						{
							...
							{
								PacketDispatcher.sendPacketToServer(PacketManager.getPacketWithID(ICBMExplosion.CHANNEL, ZhaPinPacketType.LASER_DESIGNATOR.ordinal(), objectMouseOver.blockX, objectMouseOver.blockY, objectMouseOver.blockZ));
