...
public abstract class BlockZha extends Explosion implements IExplosion
{
	public World worldObj;
	protected Vector3 position;
	protected EntityBaoZha controller = null;

	/** The amount of times the explosion has been called */
	protected int callCount = 0;

	public BlockZha(World world, Entity entity, double x, double y, double z, float size)
	{
	...
	public void explode()
	{
		...
		if (!evt.isCanceled())
		{
			if (this.proceduralInterval() > 0)
			{
				...
				{
					this.worldObj.spawnEntityInWorld(new EntityBaoZha(this));
				}
			}
			else
			{
