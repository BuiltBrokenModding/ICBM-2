 ...
 * 
 */
public class EntityBaoZha extends Entity implements IEntityAdditionalSpawnData
{
	public BlockZha baoZha;

	private boolean endExplosion = false;

	public EntityBaoZha(World par1World)
	{
		super(par1World);
	...
	public EntityBaoZha(BlockZha baoZha)
	{
	...
	protected void readEntityFromNBT(NBTTagCompound nbt)
	{
		try
		{
			...
			if (this.baoZha == null)
			{
				...
				this.baoZha = (BlockZha) constructor.newInstance(this.worldObj, null, this.posX, this.posY, this.posZ, 0);
			}
