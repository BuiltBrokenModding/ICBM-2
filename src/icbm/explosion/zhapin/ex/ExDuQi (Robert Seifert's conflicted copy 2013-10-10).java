...
import icbm.explosion.baozha.EntityBaoZha;
...
public class BzHongSu extends BlockZha
{
	...
	public boolean affectEntity(float radius, Entity entity, boolean doExplosion)
	{
		...
		if (Vector3.distance(new Vector3(entity.posX, entity.posY, entity.posZ), position) < 4)
		{
			...
			{
				if (entity instanceof EntityBaoZha)
				{
					if (((EntityBaoZha) entity).baoZha instanceof BzFanWuSu || ((EntityBaoZha) entity).baoZha instanceof BzHongSu)
					{
