...
public class BzHuo extends BaoZha
{
	...
	public void doExplode()
	{
		...
		worldObj.playSoundEffect(position.x + 0.5D, position.y + 0.5D, position.z + 0.5D, ZhuYaoICBM.PREFIX + "explosionfire", 4.0F, (1.0F + (worldObj.rand.nextFloat() - worldObj.rand.nextFloat()) * 0.2F) * 1F);
	}
