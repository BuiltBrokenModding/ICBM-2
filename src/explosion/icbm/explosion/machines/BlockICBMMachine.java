...
public class BlockICBMMachine extends BlockICBM
{
	...
	{
		LauncherBase(TileEntityLauncherBase.class), LauncherScreen(TileEntityLauncherScreen.class),
		LauncherFrame(TileEntitySupportFrame.class), RadarStation(TileEntityRadarStation.class),
		EmpTower(TileEntityEmpTower.class), CruiseLauncher(TileEntityCruiseLauncher.class),
