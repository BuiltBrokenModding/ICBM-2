...
public class TileWrapperWarheadStation extends TileEntityWrapper implements IInventoryProvider, ISidedInventory
{
	public TileWrapperWarheadStation()
	{
		super(new TileWarheadStation());
	}
