...
public class TileEntityWrappedSmallMag extends TileEntityWrapper implements IMultiTileHost, IInventoryProvider, ISidedInventory
{
	public TileEntityWrappedSmallMag()
	{
		super(new TileSmallMag());
	}
