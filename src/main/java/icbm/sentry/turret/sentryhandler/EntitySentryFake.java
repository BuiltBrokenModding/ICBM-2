...
/** Entity that fakes being the sentry gun so that the player can ride the sentry. This entity aslo
...
public class EntitySentryFake extends EntityLiving implements IEntityAdditionalSpawnData
{
    ...
    {
        //TODO cache this value and only update it when the yaw || pitch changes
