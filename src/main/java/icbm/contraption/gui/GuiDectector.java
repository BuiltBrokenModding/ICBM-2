...
public class GuiDectector extends GuiICBM
{
    ...
    public GuiDectector(TileProximityDetector tileEntity)
    {
        super(tileEntity);
    ...
    public void keyTyped(char par1, int par2)
    {
        ...
        try
        {
            ...
            PacketDispatcher.sendPacketToServer(ICBMCore.PACKET_TILE.getPacket(this.tileEntity, 2, this.tileEntity.minCoord.intX(), this.tileEntity.minCoord.intY(), this.tileEntity.minCoord.intZ()));
        }
        catch (Exception e)
        {
        }
        ...
        try
        {
            ...
            PacketDispatcher.sendPacketToServer(ICBMCore.PACKET_TILE.getPacket(this.tileEntity, 3, this.tileEntity.maxCoord.intX(), this.tileEntity.maxCoord.intY(), this.tileEntity.maxCoord.intZ()));
        }
        catch (Exception e)
        {
        ...
        try
        {
            ...
            PacketDispatcher.sendPacketToServer(ICBMCore.PACKET_TILE.getPacket(this.tileEntity, 4, this.tileEntity.frequency));
        }
        catch (Exception e)
        {
