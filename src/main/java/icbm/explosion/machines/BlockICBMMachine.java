...
public class BlockICBMMachine extends BlockICBM
{
	...
	{
		LauncherBase(TileLauncherBase.class), LauncherScreen(TileLauncherScreen.class),
		LauncherFrame(TileEntitySupportFrame.class), RadarStation(TileRadarStation.class),
		EmpTower(TileEMPTower.class), CruiseLauncher(TileCruiseLauncher.class),
