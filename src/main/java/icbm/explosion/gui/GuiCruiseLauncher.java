...
public class GuiCruiseLauncher extends GuiContainer
{
	...
	public void keyTyped(char par1, int par2)
	{
		...
		try
		{
			...
			PacketDispatcher.sendPacketToServer(ICBMCore.PACKET_TILE.getPacket(this.tileEntity, this.tileEntity.getTarget().x, this.tileEntity.getTarget().y, this.tileEntity.getTarget().z));
		}
		...
		try
		{
			...
			PacketDispatcher.sendPacketToServer(ICBMCore.PACKET_TILE.getPacket(this.tileEntity, this.tileEntity.getFrequency()));
		}
		catch (NumberFormatException e)
		{
		}
