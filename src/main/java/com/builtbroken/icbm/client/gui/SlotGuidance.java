 ...
 */
public class SlotGuidance extends Slot
{
    public SlotGuidance(IInventory inventory, int id, int x, int y)
    {
    ...
    public boolean isItemValid(ItemStack compareStack)
    {
        ...
        {
            return ((IModuleItem) compareStack.getItem()).getModule(compareStack) instanceof IGuidance;
        }
        return false;
    }
}
