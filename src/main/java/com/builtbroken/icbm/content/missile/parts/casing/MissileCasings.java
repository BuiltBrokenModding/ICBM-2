...
public enum MissileCasings
{
    ...
    MICRO(WarheadCasings.EXPLOSIVE_MICRO, MissileMicro.class, 1200, 3, 2000, true), // 1m and bellow
    //http://www.army-technology.com/projects/hellfire-ii-missile/
    SMALL(WarheadCasings.EXPLOSIVE_SMALL, MissileSmall.class, 12000, 10, 96000, true), //3m and bellow
    STANDARD(WarheadCasings.EXPLOSIVE_STANDARD, MissileStandard.class, 72000, 100, 800000, true), //7m and bellow
    MEDIUM(WarheadCasings.EXPLOSIVE_MEDIUM, MissileMedium.class, 360000, 700, 1500000, false), //16m
    LARGE(WarheadCasings.EXPLOSIVE_LARGE, MissileLarge.class, 1440000, 2000, 4500000, false); //32m
