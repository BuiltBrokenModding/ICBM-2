...
public class TileEntityCruiseLauncher extends TileEntityLauncher implements IPacketReceiver, IInventory, ISidedInventory, IRedstoneReceptor
{
	...
	public void onUpdate(float amps, float voltage, ForgeDirection side)
    {
    	if(!this.worldObj.isRemote)
	    {
			...
			PacketManager.sendTileEntityPacket(this, "ICBM", (int)0, this.electricityStored, this.frequency, this.disabledTicks, this.rotationYaw, this.rotationPitch, this.target.x, this.target.y, this.target.z);
    	}
    }
	...
	public boolean canLaunch()
	{
		...
		{
			Missile missile = Missile.list[this.containingItems[0].getItemDamage()];
