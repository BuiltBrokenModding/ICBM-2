...
public class EntityMissile extends Entity implements IEntityAdditionalSpawnData
{
    ...
    public EntityMissile lockedTarget;
	...
	public AxisAlignedBB getCollisionBox(Entity par1Entity)
    {
    	...
    	{
    		if(par1Entity instanceof EntityMissile)
        	{
    			((EntityMissile)par1Entity).normalExplode();
        	}
    	...
    	try
	    {
	    	...
	    	if(!this.isExploding)
	    	{
		    	...
		    	if(!this.worldObj.isRemote)
		    	{
		    		...
		    		{
		    			Missile.list[this.missileID].onExplode(this);
		    		}
    ...
    public void dropMissileAsItem()
    {
    	if(!this.isExploding)
    	{
	    	EntityItem entityItem = new EntityItem(this.worldObj, this.posX, this.posY, this.posZ, new ItemStack(ICBM.itemMissile, 1, this.missileID+1));
	        float var13 = 0.05F;
