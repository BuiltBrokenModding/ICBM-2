...
public class ItemGrenade extends ICBMItem
{
	public ItemGrenade(String name, int par1, int par2) 
	{
    ...
    public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        ...
        {
            par2World.spawnEntityInWorld(new EntityGrenade(par2World, par3EntityPlayer, Explosive.list[par1ItemStack.getItemDamage()].getID()));
        }
