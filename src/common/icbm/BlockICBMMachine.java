 ...
 *
 */
public class BlockICBMMachine extends BlockMachine
{
    ...
    public void onBlockPlacedBy(World par1World, int x, int y, int z, EntityLiving par5EntityLiving)
    {
        ...
        if(tileEntity instanceof IRotatable)
        {
        	...
        	switch (angle)
	        {
	        	case 0: rotatableEntity.setDirection(ForgeDirection.getOrientation(3)); break;
	        	case 1: rotatableEntity.setDirection(ForgeDirection.getOrientation(4)); break;
	        	case 2: rotatableEntity.setDirection(ForgeDirection.getOrientation(2)); break;
	        	case 3: rotatableEntity.setDirection(ForgeDirection.getOrientation(5)); break;
	        }
        }
    ...
    public static boolean canBePlacedAt(World par1World, int x, int y, int z, int metadata)
    {
    	...
    	{
    		return  par1World.getBlockMaterial(x, y-1, z).isSolid() &&
    				par1World.getBlockId(x, y, z) == 0 &&
		    		par1World.getBlockId(x, y+1, z) == 0 &&
		    		par1World.getBlockId(x, y+2, z) == 0;
    	}
    	//Radar
    	else if(metadata == 3)
    	{
    		return par1World.getBlockMaterial(x, y-1, z).isSolid() &&
		    		...
		    		par1World.getBlockId(x, y+1, z+1) == 0 &&
		    		par1World.getBlockId(x, y+1, z-1) == 0 &&
					par1World.getBlockId(x+1, y+1, z+1) == 0 &&
					par1World.getBlockId(x-1, y+1, z-1) == 0 &&
					par1World.getBlockId(x+1, y+1, z-1) == 0 &&
					par1World.getBlockId(x-1, y+1, z+1) == 0;
    	}
    ...
    public boolean onMachineActivated(World par1World, int x, int y, int z, EntityPlayer par5EntityPlayer)
    {
    	...
    	{
        	if(par5EntityPlayer.inventory.getCurrentItem().itemID == ICBM.itemLaserDesignator.shiftedIndex)
        	{
    			return false;
        	}
    		else if(par5EntityPlayer.inventory.getCurrentItem().itemID == ICBM.itemRadarGun.shiftedIndex)
        	{
    			return false;
        	}
    	}
    ...
    public void breakBlock(World par1World, int x, int y, int z, int par5, int par6)
    {
    	...
    	EntityItem entityItem = new EntityItem(par1World, x, y, z, new ItemStack(ICBM.blockMachine, 1, itemMetadata));
    ...
    public TileEntity createNewTileEntity(World var1, int metadata)
    {
    	switch(metadata)
    	{
	    	case 0: return new TileEntityLauncherBase();
	    	case 1: return new TileEntityLauncherScreen();
	    	case 2: return new TileEntityLauncherFrame();
	    	case 3: return new TileEntityRadarStation();
	    	case 4: return new TileEntityEMPTower();
	    	case 5: return new TileEntityRailgun();
	    	case 6: return new TileEntityCruiseLauncher();
    	}
    ...
    {
    	for(int i = 0; i < ItemBlockICBMMachine.names.length; i++)
    	{
    ...
    public ItemStack getPickBlock(MovingObjectPosition target, World par1World, int x, int y, int z)
    {
    	...
    	return new ItemStack(ICBM.blockMachine, 1, itemMetadata);
    }
}
