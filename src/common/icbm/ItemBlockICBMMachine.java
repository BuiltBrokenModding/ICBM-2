...
public class ItemBlockICBMMachine extends ItemBlock
{
    ...
    private static final int spawnID = ICBM.blockMachine.blockID;
    
    public ItemBlockICBMMachine(int id)
    {
        super(id);
    ...
    public boolean tryPlaceIntoWorld(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int x, int y, int z, int par7, float par8, float par9, float par10)
    {
        ...
        else
        {
            ...
            if(BlockICBMMachine.canBePlacedAt(par3World, x, y, z, metadata))
            {
                Block var9 = Block.blocksList[ItemBlockICBMMachine.spawnID];
                ...
                if(par3World.setBlockAndMetadataWithNotify(x, y, z, this.spawnID, metadata))
                {
                    if (par3World.getBlockId(x, y, z) == this.spawnID)
                    {
                        ...
                        Block.blocksList[ItemBlockICBMMachine.spawnID].onBlockPlacedBy(par3World, x, y, z, par2EntityPlayer);
                    }
