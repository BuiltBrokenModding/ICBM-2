...
public class EntityRailgun extends Entity implements IEntityAdditionalSpawnData
{
    private TileEntity controller;

	public EntityRailgun(World par1World)
    {
        super(par1World);
    ...
    public EntityRailgun(World par1World, Vector3 position, TileEntity controller)
    {
        this(par1World);
