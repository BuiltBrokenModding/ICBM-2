...
public class ItemRemote extends ItemElectric
{
	public static final int RADIUS = 100;
	public static final int ELECTRICITY_REQUIRED = 150;
	
    public ItemRemote(String name, int par1, int par2)
    {
        super(par1);
        this.iconIndex = par2;
    ...
    {	    	
    	if(par2World.isRemote)
    	{
	    	...
	    	if (objectMouseOver != null && objectMouseOver.typeOfHit == EnumMovingObjectType.TILE)
	    	{
		        ...
		        else if(tileEntity instanceof TileEntityExplosive && (blockMetadata == Explosive.Condensed.getID() || blockMetadata == Explosive.Breaching.getID()))
		        {
